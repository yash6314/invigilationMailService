    ...
    for (const qid in personMap) {
      ...
      const html = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p>You are assigned the following invigilation duties for <strong>Special Supplementary Examinations – June,2026</strong>:</p>
          ...
          <p><strong>2. All invigilators are expected to report to the allotted exam room at least 20 minutes before start of the exam for smooth operation of the QP collection/distribution. You are requested to carry your MU Id card.</strong></p>
          ...
          <p><strong>7. Washroom breaks will be allowed only between 11:30 AM and 12:15 PM during End Term examinations.</strong></p>
          ...
          <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee;">
            ...
            <p>
              <strong>Prof. Murtaza Bohra</strong><br>
              <strong>Controller of Examinations</strong><br>
              <strong>Mahindra University, Hyderabad</strong>
            </p>
          </div>
      `;
      ...
      try {
        await transporter.sendMail({
          ...
          to: p.mail,
          subject: 'Invigilation Duties - Special Supplementary Examinations – June,2026',
          html,
  ...
  try {
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Your invigilation duties for <strong>Special Supplementary Examinations – June,2026</strong> are as follows:</p>
        <table border="1" cellpadding="8" cellspacing="0" style="border-collapse:collapse;width:100%; margin: 20px 0;">
          <thead style="background:#4CAF50; color: white;">
            <tr>
              <th>Date</th>
