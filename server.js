    ...
    for (const qid in personMap) {
      ...
      const html = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p>You are assigned the following invigilation duties for <strong>Special Examination – Aug,2026</strong>:</p>
      ...
      try {
        await transporter.sendMail({
          ...
          to: p.mail,
          subject: 'Invigilation Duties - Special Examination – Aug,2026',
          html,
  ...
  try {
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Your invigilation duties for <strong>Special Examination – Aug,2026</strong> are as follows:</p>
        <table border="1" cellpadding="8" cellspacing="0" style="border-collapse:collapse;width:100%; margin: 20px 0;">
          <thead style="background:#4CAF50; color: white;">
            <tr>
              <th>Date</th>
